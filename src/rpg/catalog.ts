...
interface RpgCommandDescriptorInput {
  readonly id: string;
  readonly kind: string;
  readonly tokens: readonly string[];
}

export interface RpgCommandDescriptor extends RpgCommandDescriptorInput {
  readonly tokens: readonly string[];
}

function descriptor(input: RpgCommandDescriptorInput): RpgCommandDescriptor {
...
export const RPG_COMMAND_TOKENS = Object.freeze(
  RPG_COMMAND_DESCRIPTORS.flatMap((d) => [...d.tokens]),
);
...
export function findRpgCommandDescriptor(token: string): RpgCommandDescriptor | null {
