...
const checks = [
  ...
  [!runtimeIndex.includes('*Alaska dev* (Maurício)'), 'cartão legado de autoria removido'],
  [!runtimeIndex.includes('Para voltar à Alaska a qualquer momento'), 'retorno da identidade padrão não referencia Alaska'],
