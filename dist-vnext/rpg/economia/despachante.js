 ...
 */
import { RAMOS_MIGRADOS, ramoBanco, ramoCancelar, ramoCarteira, ramoColetarPropriedades, ramoComprarPropriedade, ramoCrime, ramoDemitir, ramoDesafio, ramoEmprego, ramoHabilidades, ramoIngredientes, ramoListar, ramoMateriais, ramoMercado, ramoPerfilRpg, ramoPropriedades, ramoReceitas, ramoResetRpg, ramoSementes, ramoSlots, ramoVagas, ramoVender, ramoVenderComida, } from './ramos.js';
/** Verdadeiro quando o ramo já saiu do monólito e não deve rodar por lá. */
export function estaMigrado(sub) {
    return RAMOS_MIGRADOS.includes(sub);
}
/**
 ...
 */
export function despachar(ctx, d, dados) {
    ...
    switch (ctx.sub) {
        ...
        case 'resetrpg':
            return ramoResetRpg(ctx, f, dados.permissaoReset, dados.mencionado, dados.membrosDoGrupo, dados.consultaBruta);
...
//# sourceMappingURL=despachante.js.map