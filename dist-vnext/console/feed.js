...
const R = ESC + '[0m';
const ANSI = /\u001b\[[0-?]*[ -/]*[@-~]/g;
const frente = (r, g, b) => ESC + '[38;2;' + r + ';' + g + ';' + b + 'm';
const fundo = (r, g, b) => ESC + '[48;2;' + r + ';' + g + ';' + b + 'm';
...
export function textoSeguroParaTerminal(texto) {
    return texto
        .replace(ANSI, '')
        .replace(/[\u0000-\u001f\u007f-\u009f]/g, ' ')
        .replace(/\s+/g, ' ')
...
function linhaCabecalho(comando, contexto, horario) {
...
export function renderEventoFeed(evento) {
