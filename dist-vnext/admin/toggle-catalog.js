...
export const ADMIN_BOOLEAN_SETTING_TOKENS = Object.freeze(ADMIN_BOOLEAN_SETTINGS.flatMap((item) => item.tokens));
...
export function findBooleanAdminSetting(command) {
    return byToken.get(String(command || '').trim().toLowerCase());
}
//# sourceMappingURL=toggle-catalog.js.map